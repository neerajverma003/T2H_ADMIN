      ...
      <div className="grid grid-cols-1 gap-8">
        ...
        {recipientType !== 'manage' && (
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-8 items-start">
              ...
              <div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    <label className="block text-xs font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Campaign Name</label>
                    <input
                      type="text"
                      required
                      value={campaignName}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    {/* Amount */}
                    <div className="space-y-2">
                      <label className="block text-xs font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Amount (₹)</label>
                      <div className="relative">
                        <span className="absolute inset-y-0 left-0 pl-4 flex items-center font-bold text-slate-400 text-base">₹</span>
                        <input
                          type="number"
                          required
                          min={100}
                    ...
                    {/* Expiry Date/Days */}
                    <div className="space-y-2">
                      <label className="block text-xs font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Validity Duration (Days)</label>
                      <input
                        type="number"
                        required
                        min={1}
                  ...
                  {/* Personal Message */}
                  <div className="space-y-2">
                    <label className="block text-xs font-extrabold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Personal Message</label>
                    <textarea
                      rows={3}
                      required
                      value={customMessage}
                  ...
                  {!isUploadMode ? (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center justify-center space-y-2">
                        ...
                        <p className="text-xs font-medium text-slate-500 dark:text-slate-400">Supports .csv and .xlsx formats</p>
                      </div>
                    </div>
                  )}
            ...
            <div className="bg-white dark:bg-[#091126]/95 rounded-3xl border border-slate-200/90 dark:border-indigo-500/25 shadow-xl dark:shadow-[0_12px_40px_-8px_rgba(0,0,0,0.7),0_0_30px_2px_rgba(99,102,241,0.18)] ring-1 ring-slate-900/5 dark:ring-white/5 backdrop-blur-xl p-6 md:p-8 flex flex-col justify-start relative overflow-hidden sticky top-24">
              ...
              <div className="text-slate-500 dark:text-slate-400 text-xs font-semibold text-center mt-8">
          ...
          <div className="bg-white dark:bg-[#091126]/95 rounded-3xl border border-slate-200/90 dark:border-indigo-500/25 shadow-xl ring-1 ring-slate-900/5 dark:ring-white/5 backdrop-blur-xl p-6 md:p-8">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50 text-slate-500 dark:border-[#1b2a47] dark:bg-[#0b1426] dark:text-slate-400 text-xs font-black uppercase tracking-widest">
                    <th className="py-4 px-4 w-12">
                      <input
                        type="checkbox"
                        checked={selectedUserEmails.length === registeredUsers.length && registeredUsers.length > 0}
                        onChange={handleSelectAllUsers}
                        className="rounded border-slate-300 text-blue-600 focus:ring-blue-500 dark:border-[#233558] dark:bg-[#15233e] w-5 h-5 cursor-pointer"
                      />
                    </th>
                ...
                <tbody className="divide-y divide-slate-100 dark:divide-[#1b2a47]">
                  {registeredUsers
                    .filter(u => {
                    ...
                    .map((u, i) => {
                      ...
                      return (
                        <tr key={i} className="hover:bg-slate-50/80 dark:hover:bg-[#111e38] transition-colors">
                          ...
                          <td className="py-4 px-4 flex items-center gap-4">
                            <div className="w-10 h-10 rounded-full bg-blue-50 text-blue-600 border border-blue-200 dark:bg-[#15233e] dark:text-blue-400 dark:border-[#233558] flex items-center justify-center font-bold text-sm shrink-0 shadow-sm">
                              {(dynamicName || 'U')[0].toUpperCase()}
                            </div>
                            <div>
                              <span className="block font-black text-sm md:text-base text-slate-900 dark:text-white">{dynamicName}</span>
                          ...
                          <td className="py-4 px-4">
                            <span className="text-xs md:text-sm font-semibold text-slate-600 dark:text-slate-300 select-all">{u.email}</span>
                          </td>
                          <td className="py-4 px-4 text-right">
                            <span className="inline-block px-3 py-1 rounded-full text-xs font-extrabold bg-emerald-50 text-emerald-700 border border-emerald-200 dark:bg-emerald-950/80 dark:text-emerald-400 dark:border-emerald-800/80">
                              VERIFIED CUSTOMER
                            </span>
                          </td>
                        </tr>
                      ...
                      return (
                        <Fragment key={camp._id || i}>
                          <tr
                            ...
                            className={`border-b border-slate-100 hover:bg-slate-50/80 dark:border-[#1b2a47] dark:hover:bg-[#111e38] transition-colors cursor-pointer ${isTracked ? 'bg-blue-50/50 dark:bg-[#15233e]' : ''}`}
                          >
                            <td className="py-4 px-4">
                              <div>
                                <span className="block font-black text-sm text-slate-900 dark:text-white">{camp.campaign_name}</span>
                            ...
                            <td className="py-4 px-4">
                              <span className="inline-block px-3 py-1 rounded text-xs font-extrabold bg-slate-100 text-slate-700 border border-slate-200 dark:bg-[#15233e] dark:text-slate-300 dark:border-[#233558] uppercase">
                                {camp.recipient_type || 'custom'}
                              </span>
                            </td>
                            <td className="py-4 px-4">
                              <span className="font-extrabold text-sm text-slate-900 dark:text-white">₹{Number(camp.gift_card_amount).toLocaleString('en-IN')}</span>
                            </td>
                            <td className="py-4 px-4">
                            ...
                            <td className="py-4 px-4 text-right">
                              <button
                                ...
                                className="w-8 h-8 rounded-full bg-slate-100 hover:bg-blue-100 text-slate-500 hover:text-blue-600 dark:bg-[#15233e] dark:hover:bg-blue-600/20 dark:text-slate-400 dark:hover:text-blue-400 flex items-center justify-center transition-colors ml-auto border border-slate-200 dark:border-[#233558]"
                              >
                                <ChevronRight size={16} className={`transition-transform duration-300 ${isTracked ? 'rotate-90 text-blue-600 dark:text-blue-400' : ''}`} />
                              </button>
                            </td>
                          </tr>
                          ...
                          {isTracked && (
                            <tr className="bg-[#0b1426]">
                              <td colSpan="6" className="p-0 border-b border-[#1b2a47]">
                                <motion.div
                                ...
                                >
                                  <div className="p-6 md:p-8 space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                                      <div className="bg-[#0d162b] p-5 rounded-2xl border border-[#1b2a47] flex flex-col justify-center">
                                        <span className="block text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">Total Recipients</span>
                                        <span className="text-xl md:text-2xl font-black text-white">{displayCamp.total_records || 0}</span>
                                      </div>
                                      <div className={`bg-[#0d162b] p-5 rounded-2xl border flex flex-col justify-center transition-all ${displayCamp.status === 'processing' ? 'border-emerald-500 animate-pulse bg-emerald-950/20' : 'border-emerald-900/50'}`}>
                                        <span className="block text-[10px] font-bold text-emerald-400 uppercase tracking-widest mb-1">Successfully Dispatched</span>
                                        <span className="text-xl md:text-2xl font-black text-emerald-400">
                                          {displayCamp.issued_cards?.length || 0}
                                        </span>
                                      </div>
                                      <div className="bg-[#0d162b] p-5 rounded-2xl border border-red-900/50 flex flex-col justify-center">
                                        <span className="block text-[10px] font-bold text-red-400 uppercase tracking-widest mb-1">Failed Records</span>
                                        <span className="text-xl md:text-2xl font-black text-red-400">{displayCamp.failed_records?.length || 0}</span>
                                      </div>
                                      <div className="bg-[#0d162b] p-5 rounded-2xl border border-blue-900/50 flex flex-col justify-center">
                                        <span className="block text-[10px] font-bold text-blue-400 uppercase tracking-widest mb-1">Voucher Amount</span>
                                        <span className="text-xl md:text-2xl font-black text-blue-400">₹{Number(displayCamp.gift_card_amount).toLocaleString('en-IN')}</span>
                                      </div>
                                    </div>

                                    {/* Progress Bar for Active Polling */}
                                    {displayCamp.status === 'processing' && (
                                      <div className="bg-[#0d162b] p-5 rounded-2xl border border-blue-900/50 space-y-2">
                                        <div className="flex justify-between items-center text-xs font-black">
                                          <span className="text-blue-400 uppercase tracking-wider animate-pulse">Campaign Dispatching in Progress...</span>
                                          <span className="text-blue-400">{getProgressPercentage(displayCamp)}%</span>
                                        </div>
                                        <div className="relative w-full h-2.5 bg-[#15233e] rounded-full overflow-hidden">
                                          <div
                                            style={{ width: `${getProgressPercentage(displayCamp)}%` }}
                                            className="absolute inset-y-0 left-0 bg-[#2563EB] rounded-full transition-all duration-300"
                                          ></div>
                                        </div>
                                      </div>
                                    )}
                                    ...
                                    <div className="bg-[#0d162b] rounded-2xl border border-[#1b2a47] overflow-hidden">
                                      <div className="px-5 py-4 bg-[#0b1426] border-b border-[#1b2a47] flex justify-between items-center">
                                        <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-1.5">
                                          <Users size={14} className="text-blue-400" /> Recipient Breakdown ({displayCamp.emails_list?.length || 0})
                                        </h4>
                                      </div>
                                      ...
                                      <div className="max-h-72 overflow-y-auto custom-scrollbar">
                                        <table className="w-full text-left border-collapse text-xs">
                                          <thead>
                                            <tr className="border-b border-[#1b2a47] text-[10px] font-black text-slate-400 uppercase tracking-widest bg-[#0b1426]">
                                          ...
                                          <tbody>
                                            {(() => {
                                              ...
                                              return displayCamp.emails_list?.map((email, idx) => {
                                                ...
                                                return (
                                                  <tr key={idx} className="border-b border-[#1b2a47] hover:bg-[#111e38] transition-colors">
                                                    <td className="py-3 px-5 font-bold text-slate-200 select-all">
                                                      {email}
                                                    </td>
                                                    <td className="py-3 px-5 font-mono font-bold text-blue-400 text-sm">
                                                      {matchingCode}
                                                    </td>
                                                    ...
                                                    <td className="py-3 px-5 text-right">
                                                      {matchingCode !== 'N/A' ? (
                                                        <button
                                                          ...
                                                          className="p-1.5 text-slate-400 hover:text-blue-400 hover:bg-[#15233e] rounded transition-all inline-flex"
                                                          title="Copy Voucher Code"
                                                        >
                                                          <Copy size={14} />
                                                        </button>
                                                      ) : (
                                                      <span className="text-slate-500 text-[10px] font-semibold italic pr-1">Not Available</span>
                                                    )}
                                                  </td>
                                                </tr>
                                              );
        ...
        {recipientType === 'manage' && (
          <div className="space-y-8">
            ...
            {/* Live Search List */}
            {searchQuery.trim() === '' ? (
              <div className="bg-[#0d162b] rounded-3xl border border-[#1b2a47] border-dashed p-16 text-center text-slate-400">
                <Gift className="mx-auto mb-4 text-blue-400 animate-pulse" size={40} />
                <h3 className="text-lg font-black text-white mb-1">Gift Card Search Center</h3>
                <p className="text-xs md:text-sm text-slate-400 max-w-md mx-auto font-semibold">
              ...
              <div className="flex justify-center items-center py-20 bg-[#0d162b] rounded-3xl border border-[#1b2a47] shadow-xl">
                <div className="w-8 h-8 border-4 border-[#2563EB] border-t-transparent rounded-full animate-spin"></div>
              </div>
            ) : filteredCards.length === 0 ? (
              <div className="bg-[#0d162b] rounded-3xl border border-[#1b2a47] border-dashed p-12 text-center text-slate-400">
                <Info className="mx-auto mb-3 text-slate-400" size={36} />
                <h3 className="text-base font-bold text-white mb-1">No Matches Found</h3>
                <p className="text-xs md:text-sm text-slate-400">Double-check the code or email you entered.</p>
              </div>
            ) : (
                ...
                {filteredCards.map((card, idx) => {
                  ...
                  return (
                    <motion.div
                      ...
                      key={card._id}
                      className={`bg-[#0d162b] border transition-all duration-300 overflow-hidden ${isExpanded
                        ? 'border-[#2563EB]/60 shadow-xl rounded-3xl'
                        : 'border-[#1b2a47] shadow-md rounded-2xl hover:border-blue-500/40 hover:shadow-lg'
                        }`}
                    >
                      {/* Row Header */}
                      <div
                      ...
                      >
                        <div className="flex items-center gap-4 w-full lg:w-auto">
                          ...
                          <div>
                            <div className="flex items-center gap-2 mb-0.5">
                              <h3 className="font-mono font-bold text-base md:text-lg text-white tracking-wider flex items-center gap-2 text-blue-400">
                                {card.public_code}
                                <button
                                  onClick={(e) => {
                                    e.stopPropagation();
                                  ...
                                  className="p-1.5 text-slate-400 hover:text-blue-400 hover:bg-[#15233e] rounded-lg transition-all"
                                  title="Copy Code"
                                >
                                  <Copy size={14} />
                                </button>
                              </h3>
                              <span className="text-[10px] font-black text-blue-400 uppercase tracking-widest bg-[#15233e] border border-[#233558] px-2 py-0.5 rounded">
                                {card.type}
                              </span>
                            </div>
                        ...
                        <div className="flex items-center justify-between w-full lg:w-auto gap-8">
                          <div className="text-left lg:text-right">
                            ...
                            <p className="font-extrabold text-sm md:text-base text-white">₹{card.amount.toLocaleString('en-IN')}</p>
                          </div>
                          <div className="text-left lg:text-right">
                          ...
                          <div className="w-9 h-9 rounded-full bg-[#15233e] flex items-center justify-center text-slate-400 group-hover:bg-[#2563EB]/20 group-hover:text-blue-400 transition-colors border border-[#233558]">
                      ...
                      <AnimatePresence>
                        {isExpanded && (
                          <motion.div
                            ...
                            exit={{ height: 0, opacity: 0 }}
                            transition={{ duration: 0.25 }}
                            className="border-t border-[#1b2a47] bg-[#0b1426]"
                          >
                            <div className="p-6 md:p-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
                              ...
                              <div className="space-y-4">
                                <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                  <Gift size={16} className="text-blue-400" /> Financial Segment
                                </h4>
                                <div className="grid grid-cols-2 gap-4">
                                  <div className="bg-[#0d162b] p-5 rounded-2xl border border-[#1b2a47] shadow-sm">
                                    <span className="block text-[10px] font-bold text-slate-400 uppercase mb-0.5">Original Value</span>
                                    <span className="text-xl md:text-2xl font-black text-white">₹{card.amount.toLocaleString('en-IN')}</span>
                                  </div>
                                  <div className="bg-[#0d162b] p-5 rounded-2xl border border-blue-900/40 shadow-sm">
                                    <span className="block text-[10px] font-bold text-blue-400 uppercase mb-0.5">Remaining Balance</span>
                                    <span className="text-xl md:text-2xl font-black text-blue-400">₹{card.remaining_balance.toLocaleString('en-IN')}</span>
                                  </div>
                                </div>
                                <div className="grid grid-cols-2 gap-4">
                                  <div className="bg-[#0d162b] p-4 rounded-2xl border border-[#1b2a47] shadow-sm">
                                    <span className="block text-[10px] font-bold text-slate-400 uppercase mb-0.5">Issued Date</span>
                                    <span className="text-xs md:text-sm font-bold text-slate-300">{new Date(card.created_at).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</span>
                                  </div>
                                  <div className="bg-[#0d162b] p-4 rounded-2xl border border-[#1b2a47] shadow-sm">
                                    <span className="block text-[10px] font-bold text-slate-400 uppercase mb-0.5">Validity Date</span>
                                    <span className="text-xs md:text-sm font-bold text-slate-300">{new Date(card.expiry_date).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</span>
                                  </div>
                                </div>
                              </div>
                              ...
                              <div className="space-y-4">
                                <h4 className="text-xs font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
                                  <Users size={16} className="text-blue-400" /> Entities Involved
                                </h4>
                                <div className="bg-[#0d162b] p-5 rounded-2xl border border-[#1b2a47] shadow-sm">
                                  <span className="block text-[10px] font-bold text-slate-400 uppercase mb-1">Purchaser / Sender</span>
                                  {card.sender_user_id ? (
                                    <div>
                                      <p className="font-black text-sm md:text-base text-white">{resolveUserName(card.sender_user_id)}</p>
                                      <p className="text-xs text-slate-400">{card.sender_user_id.email}</p>
                                    </div>
                                  ) : (
                                    <p className="font-black text-sm md:text-base text-white">Trip to Honeymoon</p>
                                  )}
                                </div>
                                <div className="bg-[#0d162b] p-5 rounded-2xl border border-[#1b2a47] shadow-sm">
                                  ...
                                  {card.accepted_by_user_id ? (
                                    <div>
                                      <p className="font-black text-sm md:text-base text-white">{resolveUserName(card.accepted_by_user_id)}</p>
                                      <p className="text-xs text-slate-400">{card.accepted_by_user_id.email}</p>
                                      <span className={`inline-block mt-2 px-2 py-0.5 text-[10px] font-black uppercase rounded border ${card.status === 'redeemed' ? 'bg-slate-800 text-slate-400 border-slate-700' :
                                          card.status === 'partially_redeemed' ? 'bg-blue-950 text-blue-400 border-blue-800' :
                                            'bg-emerald-950 text-emerald-400 border-emerald-800'
                                        }`}>
                                    ...
                                    <div>
                                      <p className="font-black text-sm md:text-base text-white">{card.recipient_name || 'N/A'}</p>
                                      <p className="text-xs text-slate-400">{card.recipient_email}</p>
                                      <span className={`inline-block mt-2 px-2 py-0.5 text-[10px] font-black uppercase rounded border ${card.status === 'redeemed' ? 'bg-slate-800 text-slate-400 border-slate-700' :
                                          card.status === 'partially_redeemed' ? 'bg-blue-950 text-blue-400 border-blue-800' :
                                            'bg-amber-950 text-amber-400 border-amber-800'
                                        }`}>
                                    ...
                                    <p className="text-xs text-slate-500 italic">Unclaimed (Self Purchase)</p>
                                  )}
                                </div>
                              </div>
                            </div>
                            ...
                            {!['expired', 'revoked', 'cancelled'].includes(card.status) && (
                              <div className="px-6 md:px-8 py-5 bg-[#0d162b] border-t border-[#1b2a47] flex items-center justify-end gap-3">
                                ...
                                <button
                                  ...
                                  className="px-5 py-2.5 bg-red-950/60 hover:bg-red-600 hover:text-white text-red-400 text-xs md:text-sm font-bold rounded-xl transition-all border border-red-800/80"
                                >
                                  Revoke Access
                                </button>
                                <button
                                  ...
                                  disabled={actionLoading}
                                  className="px-5 py-2.5 bg-amber-950/60 hover:bg-amber-600 hover:text-white text-amber-400 text-xs md:text-sm font-bold rounded-xl transition-all border border-amber-800/80"
                                >
                                  Force Expire
                                </button>
                              </div>
            ...
            <div className="bg-[#0d162b] rounded-3xl border border-[#1b2a47] shadow-xl p-6 md:p-8 mt-12">
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
                <div>
                  <h3 className="text-xl font-black text-white flex items-center gap-2">
                    <Clock className="text-blue-400" size={20} /> Generation History
                  </h3>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-3">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 bg-amber-950/60 text-amber-400 hover:bg-amber-900/60 border border-amber-800/80 rounded-xl font-bold text-sm shadow-sm transition-all"
                  >
                    <Bell size={16} className="animate-pulse" /> Send Bulk Reminders
                  </button>

                  {/* Pills filters selector */}
                  <div className="bg-[#0b1426] p-1 rounded-xl flex gap-1 border border-[#1b2a47] shadow-inner">
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse">
                  <thead>
                    <tr className="border-b border-[#1b2a47] bg-[#0b1426] text-[10px] font-black text-slate-400 uppercase tracking-widest">
                      <th className="py-4 px-4 w-12">
                        <input
                          type="checkbox"
                          className="w-4 h-4 rounded text-amber-500 focus:ring-amber-500 border-[#233558] bg-[#15233e] cursor-pointer"
                          checked={
                      ...
                      paginatedDispatchCards.map((card, i) => {
                        ...
                        const getStatusPillProps = (status) => {
                          switch (status) {
                            ...
                            case 'created':
                            case 'paid':
                              return { label: 'UNCLAIMED', color: 'bg-amber-950/80 text-amber-400 border-amber-800/80' };
                            case 'verified':
                            case 'accepted':
                            case 'active':
                              return { label: 'ACTIVE', color: 'bg-emerald-950/80 text-emerald-400 border-emerald-800/80' };
                            case 'redeemed':
                              return { label: 'REDEEMED', color: 'bg-blue-950/80 text-blue-400 border-blue-800/80' };
                            case 'expired':
                              return { label: 'EXPIRED', color: 'bg-rose-950/80 text-rose-400 border-rose-800/80' };
                            case 'revoked':
                            case 'cancelled':
                            case 'failed':
                              return { label: 'REVOKED', color: 'bg-red-950/80 text-red-400 border-red-800/80' };
                            default:
                              return { label: (status || 'UNKNOWN').toUpperCase(), color: 'bg-slate-800 text-slate-300 border-slate-700' };
                          }
                        };
                        ...
                        return (
                          <tr key={i} className="border-b border-[#1b2a47] hover:bg-[#111e38] transition-colors">
                            <td className="py-4 px-4">
                              {isEligible ? (
                                <input
                                  type="checkbox"
                                ...
                                <input type="checkbox" disabled className="w-4 h-4 rounded border-slate-700 bg-slate-900 cursor-not-allowed opacity-40" title="Not eligible for reminder" />
                              )}
                            </td>
                            <td className="py-4 px-4">
                              <div className="flex items-center gap-3">
                                ...
                                <div>
                                  <span className="block font-black text-sm md:text-base text-white truncate max-w-xs md:max-w-md">{dynamicRecipient}</span>
                            ...
                            <td className="py-4 px-4">
                              <span className="font-extrabold text-sm md:text-base text-white">₹{Number(card.amount).toLocaleString('en-IN')}</span>
                            </td>
                            <td className="py-4 px-4">
                            ...
                            <td className="py-4 px-4">
                              <div>
                                <span className="block text-xs md:text-sm font-semibold text-slate-300">
                            ...
                            <td className="py-4 px-4 text-right">
                              <div className="inline-flex items-center gap-2">
                                <button
                                  ...
                                  className="p-2 text-slate-400 hover:text-blue-400 hover:bg-[#15233e] rounded-lg transition-colors"
                                  title="View Details"
                                >
                                  <Eye size={16} />
                                </button>
                                <button
                                  ...
                                  className="p-2 text-slate-400 hover:text-emerald-400 hover:bg-[#15233e] rounded-lg transition-colors"
                                  title="Verify & Remind"
                                >
                                  <Bell size={16} />
                                </button>
                                {card.remaining_balance > 0 && !['expired', 'revoked', 'cancelled'].includes(card.status) && (
                                  <button
                                    ...
                                    className="p-2 text-slate-400 hover:text-amber-400 hover:bg-[#15233e] rounded-lg transition-colors"
                                ...
                                <button
                                  disabled={actionLoading}
                                  onClick={() => handleStatusUpdate(card._id, card.status, 'revoked')}
                                  className="p-2 text-slate-400 hover:text-red-400 hover:bg-[#15233e] rounded-lg transition-colors disabled:opacity-50"
                                ...
                                <button
                                  ...
                                  className="p-2 text-slate-400 hover:text-rose-400 hover:bg-[#15233e] rounded-lg transition-colors"
              ...
              {/* Pagination UI */}
              {totalHistoryPages > 1 && (
                <div className="flex flex-col sm:flex-row items-center justify-between border-t border-[#1b2a47] px-6 py-4 bg-[#0b1426] rounded-b-3xl mt-4 gap-4">
                  <p className="text-xs font-bold text-slate-400">
                    Showing <span className="text-white font-bold">{(historyPage - 1) * HISTORY_PAGE_SIZE + 1}</span> to <span className="text-white font-bold">{Math.min(historyPage * HISTORY_PAGE_SIZE, filteredDispatchCards.length)}</span> of <span className="text-white font-bold">{filteredDispatchCards.length}</span> records
                  </p>
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => setHistoryPage(p => Math.max(1, p - 1))}
                      disabled={historyPage === 1}
                      className="px-4 py-2 text-xs font-black text-slate-300 bg-[#15233e] border border-[#233558] rounded-lg hover:bg-[#182745] hover:text-white disabled:opacity-50 transition-colors shadow-sm"
                    >
                      PREV
                    </button>
                    <div className="px-4 py-2 text-xs font-black text-white bg-[#15233e] border border-[#233558] rounded-lg shadow-sm">
        ...
        {selectedDetailCard && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="bg-[#0d162b] rounded-3xl shadow-2xl border border-[#1b2a47] max-w-4xl w-full p-8 md:p-10 relative z-10 overflow-hidden flex flex-col gap-8 text-white"
            >
              <div className="absolute top-0 right-0 w-64 h-64 bg-blue-600/10 rounded-full blur-3xl -translate-y-16 translate-x-16"></div>

              {/* Header row */}
              <div className="flex justify-between items-center relative z-10">
                <div>
                  <span className="text-xs font-black text-blue-400 uppercase tracking-widest bg-[#15233e] border border-[#233558] px-3 py-1.5 rounded">DISPATCH RECORD OVERVIEW</span>
                  <h3 className="text-3xl font-black text-white mt-3 font-mono tracking-wider flex items-center gap-3">
                ...
                <button
                  onClick={() => setSelectedDetailCard(null)}
                  className="w-10 h-10 rounded-full bg-[#15233e] hover:bg-[#182745] flex items-center justify-center text-slate-400 hover:text-white transition-colors border border-[#233558]"
                >
                  <X size={20} />
                </button>
              </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 relative z-10 items-stretch">
                  ...
                  <div className="flex flex-col gap-8">
                    ...
                    <div className="space-y-4 relative z-10">
                      <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
                        <Gift size={18} className="text-blue-400" /> Financial Details
                      </h4>
                      <div className="grid grid-cols-2 gap-5">
                        <div className="bg-[#15233e] p-6 rounded-2xl border border-[#233558] flex flex-col justify-center">
                          <span className="block text-xs font-bold text-slate-400 uppercase mb-1">Voucher Value</span>
                          <span className="text-3xl font-black text-white">₹{selectedDetailCard.amount.toLocaleString('en-IN')}</span>
                        </div>
                        <div className="bg-[#15233e] p-6 rounded-2xl border border-blue-900/40 flex flex-col justify-center">
                          <span className="block text-xs font-bold text-blue-400 uppercase mb-1">Remaining Balance</span>
                          <span className="text-3xl font-black text-blue-400">₹{selectedDetailCard.remaining_balance.toLocaleString('en-IN')}</span>
                        </div>
                      </div>
                      <div className="grid grid-cols-2 gap-5">
                        <div className="bg-[#15233e] p-6 rounded-2xl border border-[#233558]">
                          <span className="block text-xs font-bold text-slate-400 uppercase mb-1">Issued At</span>
                          <span className="text-base font-black text-slate-200">{new Date(selectedDetailCard.created_at).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</span>
                        </div>
                        <div className="bg-[#15233e] p-6 rounded-2xl border border-[#233558]">
                          <span className="block text-xs font-bold text-slate-400 uppercase mb-1">Expiry Date</span>
                          <span className="text-base font-black text-slate-200">{new Date(selectedDetailCard.expiry_date).toLocaleDateString('en-IN', { day: '2-digit', month: 'short', year: 'numeric' })}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4 relative z-10 flex-grow">
                      <h4 className="text-sm font-black text-slate-400 uppercase tracking-widest flex items-center gap-2">
                        <Users size={18} className="text-blue-400" /> Stakeholders Involved
                      </h4>
                      <div className="bg-[#15233e] p-6 rounded-2xl border border-[#233558] space-y-4 h-full">
                        <div>
                          <span className="block text-xs font-bold text-slate-400 uppercase mb-1.5">Purchaser / Sender</span>
                          {selectedDetailCard.sender_user_id ? (
                            <div>
                              <p className="font-black text-lg text-white">{resolveUserName(selectedDetailCard.sender_user_id)}</p>
                              <p className="text-sm text-slate-400">{selectedDetailCard.sender_user_id.email}</p>
                            </div>
                          ) : (
                            <p className="font-black text-lg text-white">Trip to Honeymoon</p>
                          )}
                        </div>
                        <hr className="border-[#233558] my-2" />
                        <div>
                          <span className="block text-xs font-bold text-slate-400 uppercase mb-1.5">Recipient / Owner</span>
                          {selectedDetailCard.accepted_by_user_id ? (
                            <div>
                              <p className="font-black text-lg text-white">{resolveUserName(selectedDetailCard.accepted_by_user_id)}</p>
                              <p className="text-sm text-slate-400">{selectedDetailCard.accepted_by_user_id.email}</p>
                              <span className={`inline-block mt-2 px-3 py-1 text-xs font-black uppercase rounded border ${selectedDetailCard.status === 'redeemed' ? 'bg-slate-800 text-slate-400 border-slate-700' :
                                  selectedDetailCard.status === 'partially_redeemed' ? 'bg-blue-950 text-blue-400 border-blue-800' :
                                    'bg-emerald-950 text-emerald-400 border-emerald-800'
                                }`}>
                            ...
                            <div>
                              <p className="font-black text-lg text-white">{selectedDetailCard.recipient_name || 'N/A'}</p>
                              <p className="text-sm text-slate-400">{selectedDetailCard.recipient_email}</p>
                              <span className={`inline-block mt-2 px-3 py-1 text-xs font-black uppercase rounded border ${selectedDetailCard.status === 'redeemed' ? 'bg-slate-800 text-slate-400 border-slate-700' :
                                  selectedDetailCard.status === 'partially_redeemed' ? 'bg-blue-950 text-blue-400 border-blue-800' :
                                    'bg-amber-950 text-amber-400 border-amber-800'
                                }`}>
                            ...
                            <p className="text-sm text-slate-500 italic">Self-purchased voucher</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="space-y-4 relative z-10 mb-2 flex-grow flex flex-col">
                      ...
                      <div className="bg-[#15233e] p-6 rounded-2xl border border-[#233558] space-y-8 relative overflow-hidden flex-grow flex flex-col justify-center">
                        {/* Left vertical timeline line */}
                        <div className="absolute left-[37px] top-[40px] bottom-[40px] w-0.5 bg-[#233558] z-0"></div>

                        {/* Step 1: Generation */}
                        <div className="flex items-start gap-5 relative z-10">
                          <div className="w-7 h-7 rounded-full bg-blue-950 border-2 border-[#233558] flex items-center justify-center shrink-0 mt-0.5 text-blue-400">
                            <Check size={14} strokeWidth={4} />
                          </div>
                          <div>
                            <p className="text-base font-black text-white">Voucher Generated</p>
                            <p className="text-xs text-slate-400 font-semibold mt-1">By: {selectedDetailCard.sender_user_id ? resolveUserName(selectedDetailCard.sender_user_id) : 'System Admin (Trip to Honeymoon)'}</p>
                        ...
                        <div className="flex items-start gap-5 relative z-10">
                          ...
                          <div>
                            <p className="text-base font-black text-white">Email Dispatched</p>
                            <p className="text-xs text-slate-400 font-semibold mt-1">To: {selectedDetailCard.recipient_email || 'System Default'}</p>
                            <p className="text-xs text-slate-400 font-semibold mt-0.5">{new Date(selectedDetailCard.created_at).toLocaleString('en-IN')}</p>
                          </div>
                        </div>
                        ...
                        {/* Step 3: Claim Status */}
                        <div className="flex items-start gap-5 relative z-10">
                          <div className={`w-7 h-7 rounded-full border-2 border-[#233558] flex items-center justify-center shrink-0 mt-0.5 ${selectedDetailCard.accepted_by_user_id ? 'bg-emerald-950 text-emerald-400' : 'bg-amber-950 text-amber-400'}`}>
                            {selectedDetailCard.accepted_by_user_id ? <Check size={14} strokeWidth={4} /> : <Clock size={14} strokeWidth={4} />}
                          </div>
                          <div>
                            <p className="text-base font-black text-white">{selectedDetailCard.accepted_by_user_id ? 'Claimed & Activated' : 'Pending Acceptance'}</p>
                        ...
                        {/* Step 4: Usage Status */}
                        <div className="flex items-start gap-5 relative z-10">
                          <div className={`w-7 h-7 rounded-full border-2 border-[#233558] flex items-center justify-center shrink-0 mt-0.5 ${selectedDetailCard.remaining_balance === 0
                              ? 'bg-[#2563EB] text-white'
                              : selectedDetailCard.remaining_balance < selectedDetailCard.amount
                                ? 'bg-blue-950 text-blue-400'
                                : 'bg-[#0b1426] text-slate-500'
                            }`}>
              ...
              {!['expired', 'revoked', 'cancelled'].includes(selectedDetailCard.status) && (
                <div className="bg-[#0b1426] p-5 rounded-2xl flex justify-between items-center border border-[#1b2a47] mt-2 relative z-10">
                  ...
                  <div className="flex gap-3">
                    <button
                      ...
                      disabled={actionLoading}
                      className="px-5 py-2.5 bg-red-950/60 hover:bg-red-600 hover:text-white text-red-400 text-sm font-black rounded-xl transition-all border border-red-800/80"
                    >
                      Revoke Access
                    </button>
                    <button
                      ...
                      disabled={actionLoading}
                      className="px-5 py-2.5 bg-amber-950/60 hover:bg-amber-600 hover:text-white text-amber-400 text-sm font-black rounded-xl transition-all border border-amber-800/80"
                    >
                      Force Expire
                    </button>
                  </div>
        ...
        {verifyModalCard && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              animate={{ scale: 1, opacity: 1, y: 0 }}
              exit={{ scale: 0.95, opacity: 0, y: 15 }}
              className="bg-[#0d162b] rounded-3xl shadow-2xl border border-[#1b2a47] max-w-xl w-full p-10 relative z-10 overflow-hidden flex flex-col gap-8 text-white"
            >
              <div className="absolute top-0 right-0 w-72 h-72 bg-emerald-500/10 rounded-full blur-3xl -translate-y-16 translate-x-16 z-0"></div>

              {/* Header */}
              <div className="flex justify-between items-center relative z-10">
                <div>
                  <span className="text-xs font-black text-emerald-400 uppercase tracking-widest bg-emerald-950/80 border border-emerald-800/80 px-3 py-1.5 rounded">REMINDER EMAIL</span>
                  <h3 className="text-3xl font-black text-white mt-4 font-mono tracking-wider">
                    {verifyModalCard.public_code}
                  </h3>
                </div>
                <button
                  onClick={() => setVerifyModalCard(null)}
                  className="w-12 h-12 rounded-full bg-[#15233e] hover:bg-[#182745] flex items-center justify-center text-slate-400 hover:text-white transition-colors border border-[#233558]"
                >
                  <X size={24} />
                </button>
              </div>
              ...
              <div className="bg-[#0b1426] border border-[#1b2a47] rounded-2xl p-8 relative z-10 shadow-inner mt-2">
                <div className="flex items-start gap-5 mb-6">
                  ...
                  <div>
                    <h4 className="text-lg font-black text-white">Custom Email Reminder</h4>
                    <p className="text-sm font-semibold text-slate-400 mt-1 leading-relaxed">
                ...
                <div className="space-y-5">
                  <div className="relative group">
                    <textarea
                      rows="5"
                      className="w-full bg-[#15233e] border border-[#233558] rounded-xl p-5 text-sm md:text-base text-white font-medium focus:outline-none focus:border-[#2563EB] transition-all custom-scrollbar placeholder:text-slate-500 resize-none shadow-inner"
                      value={remindMessage}
                      onChange={(e) => setRemindMessage(e.target.value)}
                      placeholder="Type a friendly, engaging reminder message here..."
                    ></textarea>
                    <div className="absolute bottom-4 right-4 pointer-events-none">
                      <span className="bg-[#0b1426] text-slate-400 text-[10px] font-black uppercase tracking-widest px-3 py-1.5 rounded border border-[#1b2a47]">Rich Text</span>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    disabled={actionLoading}
                    className="w-full py-3.5 bg-emerald-600 hover:bg-emerald-700 disabled:opacity-50 disabled:cursor-not-allowed text-white text-sm font-black rounded-xl transition-all shadow-lg shadow-emerald-600/30 flex items-center justify-center gap-2 transform hover:-translate-y-0.5 active:translate-y-0"
                  >
        ...
        {bulkReminderModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-[#0d162b] rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden border border-[#1b2a47] my-8 text-white"
            >
              <div className="bg-amber-950/50 p-6 md:p-8 flex items-center justify-between border-b border-amber-900/60">
                <div className="flex items-center gap-4">
                  <div className="p-3 bg-[#15233e] rounded-2xl shadow-sm text-amber-400 border border-[#233558]">
                    <Bell size={28} className="animate-pulse" />
                  </div>
                  <div>
                    <h2 className="text-2xl font-black text-amber-300">Send Bulk Reminders</h2>
                    <p className="text-amber-400 font-medium mt-1">Dispatching to {selectedTableCardIds.length} selected recipients.</p>
                  </div>
                </div>
                <button onClick={() => setBulkReminderModalOpen(false)} className="p-2 text-amber-400 hover:bg-amber-900/60 rounded-full transition-colors">
                  <X size={24} />
                </button>
              </div>
              ...
              <div className="p-6 md:p-8 space-y-6">
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-4 bg-[#15233e] border border-[#233558] rounded-xl focus:border-amber-500 outline-none text-white font-medium h-32 resize-none placeholder-slate-500 shadow-inner"
                  />
                ...
                <div className="bg-[#0b1426] border border-[#1b2a47] rounded-xl p-5 flex items-start gap-3">
                  <ShieldAlert className="text-blue-400 shrink-0 mt-0.5" size={20} />
                  <div>
                    <h4 className="text-sm font-bold text-white">Smart Spam Protection Active</h4>
              ...
              {/* Footer Actions */}
              <div className="p-6 md:p-8 border-t border-[#1b2a47] bg-[#0b1426] flex items-center justify-end gap-4">
                <button
                ...
                <button
                  ...
                  className="px-8 py-3 bg-amber-600 hover:bg-amber-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-black rounded-xl shadow-lg shadow-amber-600/30 flex items-center gap-2 transition-all transform hover:scale-105 active:scale-95"
                >
        ...
        {redeemModalCard && (
          ...
          >
            <motion.div
              ...
              className="bg-[#0d162b] rounded-3xl shadow-2xl border border-[#1b2a47] max-w-lg w-full overflow-hidden text-white"
            >
              {/* Header */}
              <div className="bg-[#2563EB] p-6 md:p-8 text-white relative overflow-hidden">
                <div className="relative z-10 flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-blue-100 text-sm mt-1 font-semibold">Instantly redeem voucher over a call.</p>
                  </div>
                  <button
              ...
              {/* Body */}
              <div className="p-6 md:p-8 space-y-6">
                <div className="bg-[#15233e] border border-[#233558] rounded-2xl p-4 flex justify-between items-center">
                  <div>
                    <span className="block text-[10px] font-black text-slate-400 uppercase tracking-widest">Card Reference</span>
                    <span className="font-mono font-bold text-blue-400 text-lg">{redeemModalCard.public_code}</span>
                  </div>
                  <div className="text-right">
                    <span className="block text-[10px] font-black text-slate-400 uppercase tracking-widest">Max Available</span>
                    <span className="font-black text-white text-lg">₹{redeemModalCard.remaining_balance.toLocaleString('en-IN')}</span>
                  </div>
                </div>

                <div className="space-y-4">
                  <div>
                    <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1 flex items-center gap-1.5">
                      <DollarSign size={14} className="text-emerald-400" /> Amount to Deduct <span className="text-red-400">*</span>
                    </label>
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-8 pr-4 py-3 bg-[#15233e] border border-[#233558] rounded-xl focus:border-[#2563EB] text-base font-bold text-white transition-all outline-none"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1 flex items-center gap-1.5">
                      <FileText size={14} className="text-blue-400" /> Booking ID / Lead Ref
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full px-4 py-3 bg-[#15233e] border border-[#233558] rounded-xl focus:border-[#2563EB] text-sm font-semibold text-white transition-all outline-none placeholder-slate-500"
                    />
                  </div>

                  <div>
                    <label className="block text-xs font-black text-slate-400 uppercase tracking-widest mb-1.5 ml-1 flex items-center gap-1.5">
                      <Info size={14} className="text-amber-400" /> Admin Note
                    </label>
                    <textarea
                      value={redeemNotes}
                      ...
                      rows="2"
                      className="w-full px-4 py-3 bg-[#15233e] border border-[#233558] rounded-xl focus:border-[#2563EB] text-sm text-white transition-all outline-none resize-none placeholder-slate-500"
                    ></textarea>
                  </div>
                </div>

                <div className="bg-amber-950/40 border border-amber-900/60 rounded-xl p-4 flex items-start gap-3">
              ...
              {/* Footer */}
              <div className="p-6 border-t border-[#1b2a47] bg-[#0b1426] flex justify-end gap-3">
                <button
                  onClick={handleCloseRedeemModal}
                  className="px-5 py-2.5 font-bold text-slate-400 hover:text-white transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-6 py-2.5 bg-[#2563EB] hover:bg-blue-600 disabled:opacity-50 text-white font-black rounded-xl shadow-lg shadow-blue-600/30 flex items-center gap-2 transition-all"
                >
                  {isRedeeming ? (
