          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4">
              {data.existingImages.map((img, idx) => (
                <div key={idx} className="group relative rounded-md border border-slate-700 bg-slate-800 p-1">
                  <img src={img} alt="" className="h-28 w-full rounded-md object-cover" />
                  <span className="absolute top-1 left-1 rounded bg-emerald-600 px-2 py-0.5 text-xs text-white">
                    Existing
                  </span>
                  <label className="absolute left-1 bottom-1 rounded bg-black/60 p-1">
                    <input
                      type="checkbox"
                  ...
                  <button
                    ...
                    className="absolute right-1 top-1 rounded-full bg-red-600 p-1 text-xs text-white opacity-0 transition group-hover:opacity-100"
                  >
                    ✕
                  </button>
                </div>
