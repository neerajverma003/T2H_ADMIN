                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    {pageOptions.map((p) => (
                                        <button
                                            ...
                                            className={`px-4 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all ${activePage === p
                                            ...
                                            <div className="xl:w-1/2 p-8 flex flex-col justify-between">
                                                <div className="space-y-4">
                                                    <div className="flex items-center justify-between">
                                                        ...
                                                        <button onClick={() => handleVisibilityChange(v._id)} className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${v.visibility === "Public" ? "bg-emerald-50 text-emerald-600" : "bg-slate-200 text-slate-500"
                                                            }`}>
                                                            {v.visibility}
                                                        </button>
                                                    </div>
